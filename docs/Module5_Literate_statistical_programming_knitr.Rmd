...
knitr::include_graphics("knitr20.png")
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("knitr2.png")
```
---
class: center
# Processing a knitr document: one click
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("knitr3.png")
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("knitr4.png")
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("knitr5.png")
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("knitr6.png")
```
---
class: center
# Output
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("knitr7.png")
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("knitr8.png")
```
...
# Output
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("knitr9.png")
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("knitr10.png")
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("knitr11.png")
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("knitr12.png")
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("knitr13.png")
```
...
# Incorporating Graphics
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("knitr15.png")
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("knitr16.png")
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("knitr17.png")
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("knitr18.png")
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("knitr19.png")
```
