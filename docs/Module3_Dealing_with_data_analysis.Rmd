...
.pull-right[
![olivier gimenez](olivier gimenez.png)
]
.pull-right[
...
![tidyverse tibbles](Variable observation and measurement.png)
...
knitr::include_graphics('workflow in data analysis.png')
```
...
knitr::include_graphics('workflow data analysis within tidyverse.png')
```
...
![Twitter exercice front page](Twitter exercice front page.png)
.left[
...
You need to do complicated programming: create multiple intermediate objects; embed, needs some understanding of coding and is prone to errors.![omelette in r base](Omlete succesive command.png)
...
]![omelette in tidyverse](omelete with pipe commands.png)
...
```{r, echo=FALSE,out.width='10%', fig.align='right', fig.cap='', include=TRUE}
knitr::include_graphics('pipinglogo.png')
```
...
![Across graphics](Across graphics.png)
---
class: center
