...
knitr::include_graphics("ggplot2_logo.png") # ggplot2_logo.jpg
```
...
knitr::include_graphics("ggplot1.png") #assets/img/ggplot1.png
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("ggplot2.png") #assets/img/ggplot2.png
```
